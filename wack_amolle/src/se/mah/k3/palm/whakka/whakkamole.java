...
public class whakkamole extends Activity implements OnClickListener,
		Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		hole = new ArrayList<zeMole>();
		Button start = (Button) findViewById(R.id.button10);
		start.setOnClickListener(this);
		for (int i = 0; i < 9; i++) {
			hole.add((zeMole) findViewById(ID[i]));
